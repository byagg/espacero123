      ...
      <div className="min-h-screen bg-gray-50 py-12 px-4">
        <div className="container mx-auto max-w-md">
          <div className="bg-white p-8 rounded-lg shadow text-center">
            <h1 className="text-2xl font-bold mb-4 text-gray-800">Môj profil</h1>
            <p className="text-gray-600 mb-6">Pre zobrazenie profilu sa musíte prihlásiť.</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-6 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        {/* My Venues Section */}
        {isHost && myVenues.length > 0 && (
          <div className="mt-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Moje priestory</h2>
                ...
                <Card key={venue.id} className="bg-white border-gray-200 shadow-lg">
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 flex justify-end">
                      ...
                      <Link href={`/venues/${venue.id}/slots`}>
